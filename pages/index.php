        ...
        <div class="content">
            ...
            <div class="card-container">
                <div class="card welcome-card">
                    ...
                    <a class="action" href="join.php" title="Participate in an existing poll...">Join Poll</a>
                </div>
                <div class="card welcome-card">
                    <h3>Create a poll</h3>
                    <p>Create a poll to gather insight on a question from others.</p>
                    <a class="action" href="create.php" title="Make a new poll...">Create Poll</a>
                </div>
            </div>
            <div class="card-container">
                <div class="card welcome-card" >
                    ...
                    <a class="action secondary" href="about.php" title="Go to the About page...">About</a>
                </div>
                <div class="card welcome-card" >
